...
public class BMP280 implements AutoCloseable {

    private static final String TAG = "BMP280";
    /**
     ...
     * @throws IOException
     */
    BMP280(String bus) throws IOException {
        final PeripheralManager manager = PeripheralManager.getInstance();
        try {
            this.mDevice = manager.openI2cDevice(bus, I2C_ADDRESS);
     ...
     * @throws IOException
     */
    /*package*/  BMP280(I2cDevice device) throws IOException {
        connect(device);
    }
